...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Group2groupcache.findAll", query = "SELECT g FROM Group2groupcache g")
    , @NamedQuery(name = "Group2groupcache.findById", query = "SELECT g FROM Group2groupcache g WHERE g.id = :id")})
public class Group2groupcache implements Serializable {
    ...
    public Group2groupcache() {
    }

    public Group2groupcache(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Group2groupcache)) {
            return false;
        }
        Group2groupcache other = (Group2groupcache) object;
    ...
    public String toString() {
        return "com.edu.sangerardo.edspace.modelo.Group2groupcache[ id=" + id + " ]";
    }
